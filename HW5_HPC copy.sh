...
python experiments.py ../data5/training-data/1-billion-word-language-modeling-benchmark-r13output/training-monolingual.tokenized.shuffled/ -directory -nfiles 100 -window 10 -dimension 400 -negative 10 -embeddings ../data5/embeddings/billion_C10_N400_K10_F100.txt
